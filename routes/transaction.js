...
transactionRouter.post("/api/transaction/transfer", keycloak.protect(), async (req, res) => {
...
transactionRouter.post("/api/transaction/addTask", keycloak.protect(), async (req, res) => {
    const session = await mongoose.startSession();
    session.startTransaction()
    try {
...
transactionRouter.post("/api/transaction/buyProduct", keycloak.protect(), async (req, res) => {
    const session = await mongoose.startSession();
    session.startTransaction()
    try {
